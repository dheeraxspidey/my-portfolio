  ...
  return (
    <section className="h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="text-center px-4">
        ...
        >
          <h2 className="text-gray-400 mb-4 text-xl">Welcome to my portfolio</h2>
          ...
          <div className="flex gap-4 justify-center">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="border border-purple-500 text-purple-500 px-8 py-3 rounded-full hover:bg-purple-500 hover:text-white transition-colors"
            >
              Contact Me
            </motion.button>
          </div>
